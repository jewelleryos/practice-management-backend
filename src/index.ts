...
import { mortgageTaskRoutes } from './modules/mortgage-tasks/routes/mortgage-tasks.routes'
import { mortgagePersonalTaskRoutes } from './modules/mortgage-personal-tasks/routes/mortgage-personal-tasks.routes'
